...
import { alpha, useTheme, useThemeProps } from '@mui/material/styles';
...
import { transactionSchema } from '../validations/schema.ts';
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <Grid container sx={{borderBottom: "1px solid rgba(244, 224, 224, 1)"}}>
        <FinancialItem 
            title={"支出"}
            value={expense}
              ...
              {visibleRows.map((transaction, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{transaction.content}</TableCell>
